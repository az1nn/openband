...
describe("Badge", () => {
  ...
  it("renders with testID", () => {
    render(
      <Badge text="Active" variant="active" testID="badge-status-active" />,
    );
...
describe("Metronome", () => {
  ...
  it("calls onChange when BPM incremented", () => {
    const fn = vi.fn();
    render(
      <Metronome settings={baseSettings} onChange={fn} isPlaying={false} />,
    );
    fireEvent.click(screen.getByText("120"));
...
describe("PluginRack", () => {
  ...
  it("calls onEdit when plugin pressed", () => {
    ...
    render(
      <PluginRack plugins={plugins} onChange={() => {}} onEdit={onEdit} />,
    );
...
describe("NewProject", () => {
  it("renders nothing when hidden", () => {
    const { container } = render(
      <NewProject visible={false} onClose={() => {}} onCreate={() => {}} />,
    );
    expect(container.innerHTML).toBe("");
  });
...
describe("OneKnobProcessor", () => {
  ...
  it("renders bass boost type", () => {
    render(
      <OneKnobProcessor type="bassBoost" value={50} onChange={() => {}} />,
    );
...
describe("Synth", () => {
  it("renders nothing when hidden", () => {
    const { container } = render(
      <Synth visible={false} onClose={() => {}} bpm={120} />,
    );
    expect(container.innerHTML).toBe("");
  });
