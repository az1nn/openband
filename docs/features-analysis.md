...
| 5   | **Virtual instruments**           | ✅ Sampler, Synth, CodeSampler, PianoRoll       | ✅ Sampler    | ✅                        | ✅ Micrologue, MicroSonic, MiniSampler | **High** | OpenBand: 6-preset subtractive synth, sample-based sampler, token sequencer, MIDI piano roll                                                |
...
| 11  | **Sampler / Slicing**             | ✅ Slice mode in Sampler (transient detection, 16 pads) | ✅ Sampler    | ✅                        | ✅ MiniSampler                         | **High** | OpenBand: energy-based transient detection, threshold control, 16-pad slice mapping                                                           |
| 12  | **Chord track / helper**          | ✅ ChordTrack (8 presets, Markov suggestions)    | ❌            | ❌                        | ✅                                     | Medium   | OpenBand: 10 progression presets, harmonic Markov chain, chord-to-MIDI conversion                                                            |
| 13  | **Collaboration / sharing**       | ✅ CRDT + SSE collab, commit/push-to-cloud      | ✅            | ✅                        | ❌                                     | **High** | OpenBand: real-time CRDT sync via SSE, project branching, commit history with Supabase REST sync                                             |
| 14  | **Looper / Overdub**              | ✅                                               | ✅            | ✅                        | ✅                                     | —        | Looper component with record, loop, overdub layers, 4 independent slots                                                                      |
| 15  | **Time-stretch / pitch-shift**    | ✅ ±12 semitones, phase vocoder + granular      | ✅            | ✅                        | ✅                                     | Medium   | OpenBand: transport pitch controls, phase vocoder (FFT) for production quality, granular synthesis fallback                                 |
| 16  | **Automation**                    | ✅ Volume + pan lanes                              | ✅            | ✅                        | ✅                                     | —        | OpenBand: volume + pan; BandLab: volume + pan + effects; Cubasis: full                                                                        |
...
| 31  | **AI tools**                      | ✅ AutoMix (11 genres), AI stem analysis (LUFS, spectral) | ❌            | ✅ AutoMix, Voice Cleaner | ❌                                     | Medium   | OpenBand: role-based track classification, per-role EQ/compression profiles, LUFS target mixing                                              |
| 32  | **Keyboard shortcuts**            | ✅ Command Palette (Cmd+K, 18 commands)          | ✅            | ✅                        | ✅                                     | —        | OpenBand: command palette with search, category groups, keyboard navigation; shortcuts: play/record/undo/redo/save/mute/solo/delete          |
