...
- [x] T003 Prove deletion candidates through reference, duplicate, ownership, and history audits.
- [x] T004 Run automated design validation on the design-only candidate.
- [x] T005 Remove proven dead/redundant tracked artifacts and prevent generated test-report media from being recommitted.
