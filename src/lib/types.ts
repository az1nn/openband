...
export const PLUGIN_SPECS: Record<PluginType, PluginTypeSpec> = {
          ...
          [
            {
              ...
              max: 20000,
              step: 1,
              default: EQ_DEFAULT_BANDS[i].freq,
              unit: "Hz",
            },
            {
              id: `b${i}_gain`,
              ...
              max: 18,
              step: 0.5,
              default: EQ_DEFAULT_BANDS[i].gain,
              unit: "dB",
            },
            {
              id: `b${i}_q`,
            ...
            },
            {
              ...
              max: 5,
              step: 1,
              default: EQ_DEFAULT_BANDS[i].type,
            },
            {
              id: `b${i}_enabled`,
              label: `B${i + 1}`,
              ...
              max: 1,
              step: 1,
              default: EQ_DEFAULT_BANDS[i].enabled,
            },
          ] as PluginParamSpec[],
      ),
    ],
  ...
  limiter: {
    ...
    presets: [
      {
        name: "Transparente",
        values: { threshold: -6, ceiling: -1, attack: 0.5, release: 40 },
      },
      {
        name: "Agressivo",
        values: { threshold: -12, ceiling: -0.5, attack: 0.1, release: 20 },
      },
      {
        name: "Master Bus",
        values: { threshold: -8, ceiling: -0.3, attack: 0.3, release: 50 },
      },
    ],
  },
  distortion: {
  ...
  deesser: {
    ...
    presets: [
      {
        name: "Suave",
        values: { frequency: 6000, threshold: -18, range: 8, mode: 0 },
      },
      {
        name: "Médio",
        values: { frequency: 5000, threshold: -24, range: 12, mode: 0 },
      },
      {
        name: "Agressivo",
        values: { frequency: 7000, threshold: -30, range: 18, mode: 1 },
      },
      {
        name: "Voz Suave",
        values: { frequency: 4000, threshold: -16, range: 6, mode: 0 },
      },
    ],
  },
  tapeSaturator: {
    ...
    presets: [
      {
        name: "Warm",
        values: { drive: 4, warmth: 50, noise: 3, wow: 5, mix: 60 },
      },
      {
        name: "Tape Sat",
        values: { drive: 10, warmth: 60, noise: 8, wow: 15, mix: 75 },
      },
      {
        name: "Lo-Fi",
        values: { drive: 18, warmth: 80, noise: 30, wow: 40, mix: 90 },
      },
      {
        name: "Master Tape",
        values: { drive: 3, warmth: 40, noise: 2, wow: 3, mix: 40 },
      },
    ],
  },
  truePeakLimiter: {
  ...
  clipper: {
    ...
    presets: [
      {
        name: "Soft Clip",
        values: { threshold: -3, ceiling: -0.5, mode: 0, mix: 100 },
      },
      {
        name: "Hard Clip",
        values: { threshold: -6, ceiling: -0.5, mode: 1, mix: 100 },
      },
      {
        name: "Transparente",
        values: { threshold: -1, ceiling: -0.3, mode: 0, mix: 60 },
      },
      {
        name: "Máximo",
        values: { threshold: -10, ceiling: -1, mode: 1, mix: 100 },
      },
    ],
  },
  noiseGate: {
  ...
  bassMono: {
    ...
    presets: [
      {
        name: "Mono Bass",
        values: { crossover: 150, amount: 100, phase: 0, dryWet: 100 },
      },
      {
        name: "Sub Only",
        values: { crossover: 80, amount: 100, phase: 0, dryWet: 100 },
      },
      {
        name: "Subtle Mono",
        values: { crossover: 200, amount: 30, phase: 0, dryWet: 60 },
      },
      {
        name: "Phase Flip",
        values: { crossover: 120, amount: 100, phase: 1, dryWet: 100 },
      },
    ],
  },
  stereoWidener: {
...
export const PEDAL_PRESETS: Omit<GuitarPedal, "id" | "enabled">[] = [
  {
    ...
    type: "overdrive",
    brand: "Ibanez",
    params: { drive: 50, tone: 50, level: 50 },
  },
  {
    name: "BOSS SD-1",
    type: "overdrive",
    brand: "BOSS",
    params: { drive: 60, tone: 40, level: 55 },
  },
  {
    name: "MXR Distortion+",
    type: "distortion",
    brand: "MXR",
    params: { dist: 70, tone: 50, output: 50 },
  },
  {
    name: "ProCo RAT",
    type: "distortion",
    brand: "ProCo",
    params: { dist: 65, tone: 60, output: 55 },
  },
  {
    name: "BOSS DS-1",
    type: "distortion",
    brand: "BOSS",
    params: { dist: 70, tone: 50, level: 50 },
  },
  {
    name: "Dunlop Fuzz Face",
    type: "fuzz",
    brand: "Dunlop",
    params: { fuzz: 70, volume: 60 },
  },
  {
    name: "Big Muff Pi",
    type: "fuzz",
    brand: "EHX",
    params: { sustain: 70, tone: 50, volume: 55 },
  },
  {
    name: "BOSS CE-2 Chorus",
    type: "chorus",
    brand: "BOSS",
    params: { rate: 40, depth: 50, level: 50 },
  },
  {
    name: "MXR Phase 90",
    type: "phaser",
    brand: "MXR",
    params: { rate: 45, depth: 50, feedback: 40 },
  },
  {
    name: "BOSS BF-3 Flanger",
    type: "flanger",
    brand: "BOSS",
    params: { rate: 35, depth: 50, feedback: 45, delay: 30 },
  },
  {
    name: "BOSS TR-2 Tremolo",
    type: "tremolo",
    brand: "BOSS",
    params: { rate: 50, depth: 50, level: 50 },
  },
  {
    name: "Cry Baby Wah",
    type: "wah",
    brand: "Dunlop",
    params: { q: 60, freq: 50, mix: 80 },
  },
  {
    name: "MXR Dyna Comp",
    type: "compressor",
    brand: "MXR",
    params: { sensitivity: 60, output: 50 },
  },
  {
    name: "TC Electronic Hall",
    type: "reverb",
    brand: "TC Electronic",
    params: { decay: 50, mix: 30, tone: 50 },
  },
  {
    name: "BOSS DD-7 Delay",
    type: "delay",
    brand: "BOSS",
    params: { time: 400, feedback: 40, mix: 35 },
  },
  {
    name: "Klon Centaur",
    type: "boost",
    brand: "Klon",
    params: { gain: 40, treble: 50, output: 55 },
  },
];
...
export const CAB_PRESETS: CabModel[] = [
  {
    ...
    params: { micPosition: 50, room: 20, lowCut: 80, highCut: 8000 },
  },
  {
    id: "cab-212-twin",
    name: "2x12 Twin Reverb",
    brand: "Fender",
    speakers: "Jensen C12N",
    params: { micPosition: 40, room: 30, lowCut: 100, highCut: 7000 },
  },
  {
    id: "cab-410-bassman",
    name: "4x10 Bassman",
    ...
    params: { micPosition: 50, room: 25, lowCut: 60, highCut: 6000 },
  },
  {
    id: "cab-112-ac30",
    name: "1x12 AC30",
    brand: "Vox",
    speakers: "Celestion Blue",
    params: { micPosition: 45, room: 35, lowCut: 100, highCut: 7500 },
  },
  {
    id: "cab-412-gb",
    name: "4x12 Greenback",
    ...
    params: { micPosition: 55, room: 20, lowCut: 75, highCut: 6500 },
  },
  {
    id: "cab-212-orange",
    name: "2x12 PPC212",
    ...
    params: { micPosition: 50, room: 25, lowCut: 90, highCut: 7000 },
  },
  {
    id: "cab-115-svt",
    name: "1x15 SVT",
    brand: "Ampeg",
    speakers: 'Ampeg 15"',
    params: { micPosition: 40, room: 30, lowCut: 50, highCut: 5000 },
  },
  {
    id: "cab-810-svt",
    name: "8x10 SVT",
    brand: "Ampeg",
    speakers: 'Ampeg 10"',
    params: { micPosition: 60, room: 15, lowCut: 40, highCut: 5500 },
  },
  {
    id: "cab-412-mesa",
    name: "4x12 Rectifier",
    brand: "Mesa/Boogie",
    speakers: "Celestion V30",
    params: { micPosition: 55, room: 20, lowCut: 80, highCut: 7500 },
  },
  {
    id: "cab-112-deluxe",
    name: "1x12 Deluxe",
    brand: "Fender",
    speakers: "Jensen C12N",
    params: { micPosition: 45, room: 30, lowCut: 100, highCut: 6500 },
  },
];
