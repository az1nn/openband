          ...
          return (
            <View key={plugin.id} className="flex-row items-center mb-2">
              <View
                ...
                style={{
                  borderColor: plugin.enabled ? plugin.color : undefined,
                }}
              >
                <Text
                  className={`text-sm ${plugin.enabled ? "text-white" : "text-gray-600"}`}
                >
                  {i + 1}
                </Text>
              </View>
              ...
              >
                ...
                <View className="flex-1">
                  <Text
                    className={`text-xs font-semibold ${plugin.enabled ? "text-white" : "text-gray-500"}`}
                  >
                    {plugin.name}
                  </Text>
                  <Text
                    className={`text-[9px] ${plugin.enabled ? "text-gray-500" : "text-gray-600"}`}
                  >
