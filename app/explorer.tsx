...
// Deliberate exception to the 3D guideline: this screen renders inside a sandboxed iframe (srcDoc) that needs three/addons (OrbitControls), which loadThree() does not expose; migration is out of scope.
